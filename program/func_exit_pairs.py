...
async def manage_trade_exits(client):
    ...
    for position in open_positions_dict:
        ...
        market_m1_data = await fetch_market_data(client, position_market_m1)
        market_m2_data = await fetch_market_data(client, position_market_m2)
        ...
        if is_close:
            ...
            tick_size_m1 = market_m1_data["tickSize"]
            tick_size_m2 = market_m2_data["tickSize"]
