...
async def manage_trade_exits(client):
    ...
    for position in open_positions_dict:
        ...
        if is_close:
            ...
            accept_price_m1 = format_number(price_m1 * (1.05 if side_m1 == "BUY" else 0.97), tick_size_m1)
            accept_price_m2 = format_number(price_m2 * (1.05 if side_m2 == "BUY" else 0.97), tick_size_m2)
